			...
			\begin{minipage}{.98\textwidth}  % tweaks the width, makes a new \textwidth
				\parbox[t][\columnheight]{\textwidth}{
					\begin{myblock}{Introduction}
				        ...
				        \begin{figure}
				            \centering
				            \includegraphics[width=0.95\linewidth]{img/love-is-real-cats-and-dogs-4.jpg}
					...
					\begin{myblock}{Engagement}
                        ...
                        \begin{figure}
                            \centering
                            \fbox{\includegraphics[scale=1]{img/loremipsum_exampletext.png}}
                        ...
                        \begin{figure}
                            \centering
                            \includegraphics[scale=0.7]{img/lorem_ipsum_image.jpg}
					...
					\begin{myblock}{Short example}
					    ...
					    \begin{columns}
					        \begin{column}{0.45\textwidth}
					            \begin{figure}
					                \centering
					                \includegraphics[width=0.9\linewidth]{img/catdog.jpg}
					                \caption{A catdog}
					                \label{fig:my_label}
					            \end{figure}
					        \end{column}
					    ...
					    \begin{figure}
					        \centering
					        \includegraphics[scale=0.45]{img/cnn.jpg}
					    ...
					    \begin{figure}
					        \centering
					        \includegraphics[scale=0.6]{img/accuracy_train.png}
					        \caption{Caption}
					        \label{fig:my_label}
					    \end{figure}
